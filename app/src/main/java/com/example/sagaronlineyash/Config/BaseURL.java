package com.example.sagaronlineyash.Config;
...
public class BaseURL {
    ...
    public static String BASE_URL = "https://sagaronlineshopping.anshuwap.com/";
    ...
    public static String GET_FEATURED_SLIDER_URL = BASE_URL + "index.php/api/get_feature_banner";
